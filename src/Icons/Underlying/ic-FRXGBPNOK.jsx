...
const IconFRXGBPNOK = () => <Icon icon={SVGFRXGBPNOK}/>

IconFRXGBPNOK.displayName = 'IconFRXGBPNOK';
SVGFRXGBPNOK.displayName = 'SVGFRXGBPNOK';

export { IconFRXGBPNOK, SVGFRXGBPNOK };