...
const IconFRXGBPJPY = () => <Icon icon={SVGFRXGBPJPY}/>

IconFRXGBPJPY.displayName = 'IconFRXGBPJPY';
SVGFRXGBPJPY.displayName = 'SVGFRXGBPJPY';

export { IconFRXGBPJPY, SVGFRXGBPJPY };